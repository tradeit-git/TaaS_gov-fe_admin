...
(function () {
    ...
    var b = document, h = window, n = b.documentElement, c = false, u = true, i = null, q;
        ...
        if (typeof JSON.parse !== "function") {
            JSON.parse = function (H, E) {
                ...
                if (/^[\],:{}\s]*$/.test(H.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, "@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, "]").replace(/(?:^|:|,)(?:\s*\[)+/g, ""))) {
                    G = txEval("(" + H + ")");
                    return typeof E === "function" ? F({"": G}, "") : G
                }
    ...
    (function () {
        ...
        Function.prototype.bind = function () {
            var z = this, B = $A(arguments), A = B.shift();
            return function () {
        ...
        Object.extend(t, {
            extend: Object.extend, browser: function () {
                if (t.msie) {
                    return "msie"
                } else {
                    if (t.gecko) {
    ...
    (function () {
        ...
        if (t.msie_nonstd) {
            t.setOpacity = function (w, z) {
                w = t(w);
                var y = t.getStyle(w, "filter"), x = w.style;
                if (z == 1 || z === "") {
    ...
    (function () {
        if (typeof (HTMLElement) != q + "") {
            ...
            var w = x.__proto__ = {__proto__: x.__proto__};
        ...
        if (typeof (b.implementation) != q + "") {
            if (b.implementation.hasFeature("XPath", "3.0")) {
                ...
                if (typeof (Element) != q + "") {
                    ...
                    var e = y.__proto__ = {__proto__: y.__proto__};
    ...
    d.dom.TAGS_TO_IGNORE_ = {SCRIPT: 1, STYLE: 1, HEAD: 1, IFRAME: 1, OBJECT: 1};
    d.dom.PREDEFINED_TAG_VALUES_ = {IMG: " ", BR: "\n"};
    ...
    d.dom.getTextContent_ = function (x, w, e) {
        if (x.nodeName in d.dom.TAGS_TO_IGNORE_) {
        } else {
    ...
    d.dom.TagWalkType = {START_TAG: 1, OTHER: 0, END_TAG: -1};
    ...
    d.dom.SavedCaretRange.prototype.createCaret_ = function (e) {
        return this.dom_.createDom(d.dom.TagName.SPAN, {id: e ? this.startCaretId_ : this.endCaretId_})
    };
    ...
    d.dom.RangeType = {TEXT: "text", CONTROL: "control", MULTI: "mutli"};
    ...
    d.dom.RangeEndpoint = {START: 1, END: 0};
    ...
    d.dom.browserrange.AbstractRange.prototype.containsRange = function (C, A) {
        ...
        var B = d.dom.RangeEndpoint.START, w = d.dom.RangeEndpoint.END;
        try {
            if (y) {
    ...
    d.dom.browserrange.IeRange.prototype.getEndpointNode_ = function (I, D) {
        ...
        var x = d.dom.RangeEndpoint.START, E = d.dom.RangeEndpoint.END;
        var A = I == x;
        for (var F = 0, z = B.childNodes.length;
             F < z; F++) {
            var G = A ? F : z - F - 1;
    ...
    d.dom.browserrange.Error = {NOT_IMPLEMENTED: "Not Implemented"};
    ...
    var g = {
        ...
        __KEY: {ENTER: "13", DELETE: "46", SPACE: "32", BACKSPACE: "8", TAB: "9", PASTE: "86", CUT: "88"},
        I: {},
        X: {},
        define: function (e, w) {
    ...
    (function (e) {
        Object.extend(e, {
            installs: [], registers: [], modules: [], modulesX: [], install: function (x, w) {
                w.desc = "[install] " + x;
                e.installs.push(w)
    ...
    var m = function (x, y, e, w) {
        return {data: x, style: {padding: y, backgroundColor: e, border: w}}
    };
    g.__CONFIG_COMMON = {
        thumbs: {
            options: [{color: "#FF0000"}, {color: "#FF5E00"}, {color: "#FFBB00"}, {color: "#FFE400"}, {color: "#ABF200"}, {color: "#1FDA11"}, {color: "#00D8FF"}, {color: "#0055FF"}, {color: "#0900FF"}, {color: "#6600FF"}, {color: "#FF00DD"}, {color: "#FF007F"}, {color: "#000000"}, {color: "#FFFFFF"}, {color: "#FFD8D8"}, {color: "#FAE0D4"}, {color: "#FAECC5"}, {color: "#FAF4C0"}, {color: "#E4F7BA"}, {color: "#CEFBC9"}, {color: "#D4F4FA"}, {color: "#D9E5FF"}, {color: "#DAD9FF"}, {color: "#E8D9FF"}, {color: "#FFD9FA"}, {color: "#FFD9EC"}, {color: "#F6F6F6"}, {color: "#EAEAEA"}, {color: "#FFA7A7"}, {color: "#FFC19E"}, {color: "#FFE08C"}, {color: "#FAED7D"}, {color: "#CEF279"}, {color: "#B7F0B1"}, {color: "#B2EBF4"}, {color: "#B2CCFF"}, {color: "#B5B2FF"}, {color: "#D1B2FF"}, {color: "#FFB2F5"}, {color: "#FFB2D9"}, {color: "#D5D5D5"}, {color: "#BDBDBD"}, {color: "#F15F5F"}, {color: "#F29661"}, {color: "#F2CB61"}, {color: "#E5D85C"}, {color: "#BCE55C"}, {color: "#86E57F"}, {color: "#5CD1E5"}, {color: "#6699FF"}, {color: "#6B66FF"}, {color: "#A366FF"}, {color: "#F261DF"}, {color: "#F261AA"}, {color: "#A6A6A6"}, {color: "#8C8C8C"}, {color: "#CC3D3D"}, {color: "#CC723D"}, {color: "#CCA63D"}, {color: "#C4B73B"}, {color: "#9FC93C"}, {color: "#47C83E"}, {color: "#3DB7CC"}, {color: "#4174D9"}, {color: "#4641D9"}, {color: "#7E41D9"}, {color: "#D941C5"}, {color: "#D9418D"}, {color: "#747474"}, {color: "#5D5D5D"}, {color: "#980000"}, {color: "#993800"}, {color: "#997000"}, {color: "#998A00"}, {color: "#6B9900"}, {color: "#2F9D27"}, {color: "#008299"}, {color: "#003399"}, {color: "#050099"}, {color: "#3D0099"}, {color: "#990085"}, {color: "#99004C"}, {color: "#4C4C4C"}, {color: "#353535"}, {color: "#670000"}, {color: "#662500"}, {color: "#664B00"}, {color: "#665C00"}, {color: "#476600"}, {color: "#22741C"}, {color: "#005766"}, {color: "#002266"}, {color: "#030066"}, {color: "#290066"}, {color: "#660058"}, {color: "#660033"}, {color: "#212121"}, {color: "#000000"}],
            transparent: {
                color: "transparent",
                border: "#999999",
    ...
    var p = function () {
        ...
        var E = {
            ...
            params: [],
            events: {preventUnload: u, useHotKey: u},
            save: {},
            adaptor: {},
            toolbar: {},
            sidebar: {attachbox: {}, embeder: {}, attacher: {}, searcher: {}},
            plugin: {}
        };
        var y = function () {
            return {
    ...
    Object.extend(v, {__POSITION: {__START_OF_TEXT: -1, __MIDDLE_OF_TEXT: 0, __END_OF_TEXT: 1, __EMPTY_TEXT: -2}});
    Object.extend(v, {
    ...
    Object.extend(v, {
        replace: function (z, A) {
            ...
            if (v.getName(z) == v.getName(A)) {
                ...
                var x = [], B = z.childNodes, e = B.length;
                for (var w = 0; w < e; w++) {
                    x.push(B[w])
                }
                for (w = 0; w < e; w++) {
    ...
    (function () {
        ...
        var y = g.Class.create({
            $const: {
                ...
                this.unitConverter = {px2em: 1 / 12, px2pt: 9 / 12, em2px: 12, em2pt: 9, pt2px: 12 / 9, pt2em: 1 / 9}
    ...
    Object.extend(v, {
        goInto: function (w, e) {
            ...
            if (C != "none" && C != i) {
                A = {width: z.offsetWidth, height: z.offsetHeight}
            } else {
                var x = z.style;
                var E = x.visibility;
                var B = x.position;
            ...
            return {x: D[0], y: D[1], width: A.width, height: A.height}
        }, getWidth: function (w) {
            var e = w.style.width;
            if (e.isPx()) {
                return e.parsePx()
    ...
    Object.extend(v, {EMPTY_PARAGRAPH_HTML: "<p>" + v.EMPTY_BOGUS + "</p>"});
    h.$tom = v;
    (function (e) {
        e.Util = {
            _dispElIds: [], getDispElId: function () {
                var x;
                do {
        ...
        e.Paging = e.Class.create({
            $const: {DEFAULT_PAGE_SIZE: 5, DEFAULT_BLOCK_SIZE: 10}, initialize: function (y, x) {
                this.data = y;
        ...
        e.Slidebar = e.Class.create({
            initialize: function (x) {
                ...
                this.logicObj = {interval: x.interval || 5, min: x.min || 0, max: x.max || 100};
                this.physicObj = {min: 0, width: x.barSize || 100};
                ...
                t.setStyle(this.elKnob, {left: x.toPx()});
        ...
        e.DynamicSizer.PreviewTable = e.Class.create({
            $const: {
                DEFAULT_TD_STYLE: {},
                DEFAULT_TABLE_PROPERTY: {cellpadding: "0", cellspacing: "1"},
                ...
                this.cellSize = {width: Math.round((A.width - A.x) / x.COL), height: (A.height - A.y) / x.ROW}
                ...
                for (var A = 0; A < y.MAX_SIZE.ROW; A++) {
                    ...
                    for (var x = 0; x < y.MAX_SIZE.COL; x++) {
                        var E = tx.td(tx.div({style: y.DEFAULT_TD_STYLE}));
                ...
                t.setStyle(this.elSelection, {width: z, height: x})
            }, setCoordToAttr: function (y, x, z) {
                y.setAttribute("col", x);
                y.setAttribute("row", z);
                return y
            }, getCoordFromAttr: function (x) {
                return {col: x.getAttribute("col") || 0, row: x.getAttribute("row") || 0}
    ...
    g.TableUtil = {
        isDaumTable: function (e) {
            ...
            if (1 < w.colSpan && w.style.width) {
                ...
                v.setStyles(w, {width: Math.floor(e / w.colSpan) + "px"}, u)
            }
        }, splitHeightByRowSpan: function (w) {
            var e;
            if (1 < w.rowSpan && w.style.height) {
                e = parseInt(w.style.height, 10);
                v.setStyles(w, {height: Math.floor(e / w.rowSpan) + "px"}, u)
            }
    ...
    g.I.JobObservable = g.Faculty.create({
        jobObservers: {}, observeJob: function (w, e) {
    ...
    g.I.KeyObservable = g.Faculty.create({
        keyObservers: {}, observeKey: function (x, w) {
            var e = function (y) {
    ...
    g.I.ElementObservable = g.Faculty.create({
        elementObservers: {}, observeElement: function (x, e) {
            if (x == i) {
                this.observeElement({tag: "*tx-final-body*"}, e)
            } else {
                if (x.length) {
                    for (var w = 0; w < x.length; w++) {
                        var y = x[w];
    ...
    g.I.MouseoverObservable = g.Faculty.create({
        mouseoverObservers: {}, observeMouseover: function (e, w, x) {
            if (!this.mouseoverObservers[e]) {
                this.mouseoverObservers[e] = {success: [], fail: [], flag: c}
            }
    ...
    g.I.Runnable = g.Faculty.create({
        isRunning: c, repeater: i, threads: [], startThread: function (e) {
            if (this.repeater) {
                this.repeater.clear()
            } else {
    ...
    g.I.ColorPallete = g.Faculty.create({
        isGradeInit: c, isPickerDisplayed: c, onregenerated: function (e, w) {
            ...
            if (x.texts) {
                ...
                g.MarkupTemplate.get("menu.colorpallete.text").evaluateToDom({items: K}, D);
            ...
            if (x.thumbs) {
                ...
                g.MarkupTemplate.get("menu.colorpallete.thumb").evaluateToDom({items: C}, I);
            ...
            this.iChromPos = {x: (w[0] + e[0]), y: (w[1] + e[1])};
            e = t.positionedOffset(this.elHueBar);
            this.iHuePos = {x: (w[0] + e[0]), y: (w[1] + e[1])}
    ...
    g.I.CookieBaker = g.Faculty.create({
        cookieName: i, cookieValue: i, initCookie: function (e, w) {
            this.cookieName = e;
    ...
    g.Button = g.Class.create({
        ...
        increaseZindex: function () {
            ...
            if (v.parent(this.elButton)) {
                t.setStyle(v.parent(this.elButton), {zIndex: e})
            }
        },
    ...
    g.Button.Select = g.Class.create({
        $extend: g.Button, ongenerated: function () {
            g.MarkupTemplate.get("button.select.text").evaluateToDom({data: v.getText(this.elIcon)}, this.elIcon);
    ...
    g.Button.Toggle = g.Class.create({
        $extend: g.Button, setValue: function (e) {
            if (e) {
                this.pushedState()
            } else {
                this.normalState()
    ...
    g.Button.Widget = g.Class.create({
        $extend: g.Button.Select, setText: function (e) {
    ...
    g.Button.ColorWidget = g.Class.create({
        $extend: g.Button.Widget, setValue: function (e) {
            t.setStyle(this.elIcon.parentNode, {backgroundColor: e});
            this.lastValue = e
        }, setText: function () {
        }
    });
    j.addMsg({"@menu.pallete.enter": "\uc785\ub825", "@menu.pallete.more": "\ub354\ubcf4\uae30"});
    g.Menu = g.Class.create({
        $mixins: [g.I.JobObservable], isInit: c, isDisplayed: c, _command: function () {
        }, setCommand: function (e) {
            this._command = e
        }, initialize: function (e) {
            var x = this.config = e;
            ...
            this.isDisplayed = u;
            this.fireJobs(g.Ev.__MENU_LAYER_SHOW, {detail: {menu: this}})
        }, lazyGenerate: function (e) {
            var w = this;
            new (g.Class.create({
                $mixins: [g.I.JSRequester], initialize: function () {
            ...
            t.hide(this.elMenu);
            this.isDisplayed = c;
            this.fireJobs(g.Ev.__MENU_LAYER_HIDE, {detail: {menu: this}})
        }, toggle: function () {
            if (this.isDisplayed) {
                this.hide()
            } else {
    ...
    g.Menu.Select = g.Class.create({
        $extend: g.Menu, generate: function () {
            var x = this.config;
            ...
            var w = g.MarkupTemplate.get("menu.select").evaluateAsDom({items: this.generateListItem(z)});
    ...
    g.Menu.List = g.Class.create({
        $extend: g.Menu, generate: function () {
            ...
            var x = g.MarkupTemplate.get("menu.list").evaluateAsDom({items: g.MarkupTemplate.get("menu.items").evaluate(e)});
    ...
    g.Menu.Matrix = g.Class.create({
        $extend: g.Menu, generate: function () {
            ...
            var C = g.MarkupTemplate.get("menu.matrix").evaluateAsDom({matrices: E});
    ...
    g.Menu.ColorPallete = g.Class.create({
        $extend: g.Menu, $mixins: [g.I.ColorPallete], generate: function () {
            var w = this.config;
            var x = this.elMenu;
            ...
            t.observe(this.elMore, "click", function (w) {
                e.fireJobs(g.Ev.__MENU_LAYER_CHANGE_SIZE, {detail: {menu: e}})
            })
        }
    });
    ...
    g.Editor = g.Class.create({
        ...
        initialize: function (x) {
            ...
            var C = this, B = this.config = p.setup(x);
    ...
    g.Toolbar = g.Class.create({
        $mixins: [g.I.JobObservable], el: i, tools: i, initialize: function (e, w) {
            ...
            return e
        }, widgetSeq: 0, makeWidget: function (x, A, y) {
            var w = this;
            var z = this.canvas;
            var e = new (function () {
    ...
    g.module("bind events with tools", function (y, C, e, w) {
        ...
        w.observeKey({ctrlKey: c, altKey: c, shiftKey: c, keyCode: 27}, D);
        y.observeKey({ctrlKey: c, altKey: c, shiftKey: c, keyCode: 27}, D);
    ...
    g.Tool = g.Class.draft({
        identity: i, button: i, menu: i, initialize: function (w, x, e) {
            ...
            this.buttonCfg = p.merge({id: "tx_" + this.identity}, e);
            this.menuCfg = p.merge({id: "tx_" + this.identity + "_menu"}, e);
            this.oninitialized.bind(this)(e)
    ...
    g.AsyncTool = g.Class.draft({
        $extend: g.Tool, oninitialized: function () {
            this.loaded = false;
            ...
            EditorJSLoader.asyncLoadModule({
                url: p.getUrl(w), callback: function () {
                    e.loaded = true
                }
            })
    ...
    g.Sidebar = g.Class.create({
        ...
        }, $mixins: [g.I.JobObservable], entryboxRegistry: i, initialize: function (e) {
            var w = e.getCanvas();
    ...
    g.EntryBox = g.Class.draft({
        $mixins: [g.I.JobObservable], autoSeq: 0, datalist: [], initialize: function () {
    ...
    g.Entry = g.Class.draft({
        $mixins: [g.I.JobObservable], existStage: c, deletedMark: c, initialize: function () {
            ...
            return {name: this.field.name, value: [this.field.value, this.existStage].join("|")}
        }, exchangeHandlerAtReload: function () {
        }
    });
    g.Actor = g.Class.draft({
        $mixins: [g.I.JobObservable], isDisabled: c, initialize: function () {
            ...
            if (y.length < 1) {
                ...
                var e = y[0];
                var w = {regHtml: e.regHtml, regText: e.regText};
                e.setProperties(A);
                e.execReplace(w)
            }
    ...
    g.Docparser = g.Class.create({
        initialize: function (w, x, e) {
            ...
            this.sidebar = x;
            this.config = e
        }, filters: {}, registerFilter: function (e, w) {
            this.filters[e] = w
    ...
    g.EntryProxy = g.Class.create({
        initialize: function (w, x, e) {
            ...
            this.sidebar = x;
            this.config = e
        }, commands: {}, registerCommand: function (e, w) {
            this.commands[e] = w
            ...
            e.each(function (y) {
                ...
                if (w || y.existStage) {
                    x.push({
                        ...
                        data: Object.extend(y.data, {tmpSeq: y.dataSeq})
                    })
                }
            });
            return x
    ...
    g.install("editor.getSaver & editor.getDataAsJSON & editor.setDataByJSON", function (x, y, z, w, e) {
        ...
        x.getDataAsJSON = function () {
            ...
            return {
                inputmode: w.getCurrentPanel().getName(), content: B, attachments: function () {
    ...
    g.Save = g.Class.create({
        editor: i, toolbar: i, sidebar: i, canvas: i, config: i, form: i, initialize: function (x, y, z, w, e) {
            this.editor = x;
            this.toolbar = y;
            this.sidebar = z;
            this.canvas = w;
            ...
            x.createField(tx.textarea({name: "tx_content", style: {display: "none"}}, e));
            var w = y.getFields();
            w.each(function (z) {
                x.createField(tx.input({type: "hidden", name: z.name, value: z.value}))
            })
        }
    });
    ...
    p.add({resizer: {minHeight: 200}});
    g.Resizer = g.Class.create({
        $const: {__Identity: "resizer"}, $mixins: [g.I.JobObservable], initialize: function (x, e) {
            var A = 0;
            if (!x) {
                return
            }
    ...
    g.I.History.Webkit = {
        getRangeData: function () {
            var z = this.canvas.getProcessor(), A = z.getTxSel(), y = A.getSel().rangeCount;
            var B, w;
            if (y) {
            ...
            var e = 0, B = document.createRange();
            B.setStart(D, 0);
            B.collapse(true);
            var A = [D], x, y = false, F = false;
            while (!F && (x = A.pop())) {
                if (x.nodeType == 3) {
                    var C = e + x.length;
    ...
    g.I.History.Trident = {
        getRangeData: function () {
            ...
            try {
                ...
                var C = z.text.length;
                return {start: C, end: C + w.text.length}
            } catch (A) {
            }
            var x = z.text.length;
    ...
    (function () {
        ...
        g.History = g.Class.create({
            ...
            setupHistory: function () {
                this.initHistory({content: v.EMPTY_PARAGRAPH_HTML, scrollTop: 0})
            },
            canUndo: function () {
            ...
            initHistory: function (B) {
                ...
                z.redoMementoList = [];
                var A = new w();
                var y = Object.extend({content: v.EMPTY_PARAGRAPH_HTML, scrollTop: 0}, B);
                A.addUndoData(y);
                    ...
                    if (z.code == g.__KEY.DELETE || z.code == g.__KEY.BACKSPACE) {
                        ...
                        if ((z.code == g.__KEY.PASTE || z.code == g.__KEY.CUT) && z.ctrl) {
                            ...
                            if (((z.code > 32 && z.code < 41) && z.shift) || (z.code == 65 && z.ctrl)) {
                                ...
                                if (z.ctrl || z.alt || (z.shift && z.code == 16)) {
                                } else {
                                    y.contentModified = u
                                }
                            }
    ...
    (function (w) {
        ...
        w.Canvas = w.Class.create({
            ...
            initialize: function (y, A) {
                ...
                this.setCanvasSize({height: z.initHeight})
            },
            ...
            initContent: function (y) {
                this.history.initHistory({content: y});
                this.panels[this.mode].setContent(y);
                this.includeWebfontCss(y);
    ...
    (function () {
        g.Canvas.WysiwygPanel = g.Class.create({
            ...
            $const: {__MODE: g.Canvas.__WYSIWYG_MODE, EVENT_BINDING_DELAY: 500},
    ...
    g.Canvas.TextareaPanel = g.Class.create({
        $extend: g.Canvas.BasedPanel, initialize: function (w, e) {
    ...
    g.Canvas.HtmlPanel = g.Class.create({
        $extend: g.Canvas.TextareaPanel, $const: {__MODE: g.Canvas.__HTML_MODE}, initialize: function (w, e) {
            this.$super.initialize(w, e);
            this.bindEvents();
            if (t.msie_ver == "8") {
            ...
            if (!e.styles.notApplyBgColorOnSourceMode) {
                if (e.styles.backgroundColor) {
                    t.setStyle(this.el, {backgroundColor: e.styles.backgroundColor})
                }
                if (e.styles.color) {
                    t.setStyle(this.el, {color: e.styles.color})
                }
            }
        }, bindEvents: function () {
            var e = {
    ...
    g.Canvas.TextPanel = g.Class.create({
        $extend: g.Canvas.TextareaPanel, $const: {__MODE: g.Canvas.__TEXT_MODE}, initialize: function (w, e) {
            this.$super.initialize(w, e);
            this.bindEvents()
        }, bindEvents: function () {
            var e = {
    ...
    g.I.Marker.Standard = {
        paste: function () {
            ...
            var y = this.endMarker = this.processor.create("span", {id: "tx_end_marker"});
            var w = e.endOffset;
            if (B.nodeType == 3) {
                B.splitText(w);
            ...
            var A = this.startMarker = this.processor.create("span", {id: "tx_start_marker"});
            var x = e.startOffset;
            if (z.nodeType == 3) {
                z.splitText(x);
    ...
    g.Canvas.Bookmark = g.Class.create({
        startContainer: i, startOffset: 0, endContainer: i, endOffset: 0, initialize: function (e) {
            this.processor = e;
            this.win = e.win;
            this.doc = e.doc;
            this.dummy = function () {
    ...
    g.I.Processor.Standard = {
        txSelection: i, isRangeInsideWysiwyg: c, lastRange: i, initialize: function (w, e) {
            this.win = w;
            this.doc = e;
            ...
            if (z) {
                ...
                this.executeUsingCaret(function (E, H) {
                    var F = H.getCaret(c), D = H.getCaret(c);
            ...
            if (this.hasControl()) {
                ...
                this.execWithMarker(function (A) {
                    ...
                    while (C.hasNext()) {
                        B = C.next();
                        if (v.kindOf(B, "#tx_start_marker,#tx_end_marker")) {
                        } else {
                            z.push(B)
                        }
                    }
            ...
            if (this.hasControl()) {
                ...
                this.execWithMarker(function (D) {
                    if (D.checkCollapsed()) {
                        ...
                        x.bookmarkTo({startContainer: C, startOffset: 1, endContainer: C, endOffset: 1});
                        B.push(C)
                    } else {
                        ...
                        while (F.hasNext()) {
                            E = F.next();
                            if (v.kindOf(E, "#tx_start_marker,#tx_end_marker")) {
                            } else {
                                if (v.kindOf(E, "br")) {
                                } else {
                                    B.push(E)
    ...
    g.module("delete image element @when backspace key event fires", function (w, x, y, e) {
        if (t.msie_nonstd) {
            e.observeKey({ctrlKey: c, altKey: c, shiftKey: c, keyCode: g.__KEY.BACKSPACE}, function () {
                var A = e.getProcessor();
    ...
    g.module("interrupt enter key action @ wysiwyg panel", function (w, x, z, e) {
        ...
        e.observeKey({ctrlKey: c, altKey: c, shiftKey: c, keyCode: g.__KEY.ENTER}, function (B) {
            if (!e.isWYSIWYG()) {
                return
            }
            var A = e.getProcessor();
    ...
    g.Canvas.Processor = g.Class.draft({$mixins: [g.I.Processor.Standard, ((t.msie_nonstd) ? g.I.Processor.Trident : {}), ((t.msie_std) ? g.I.Processor.TridentStandard : {}), ((t.gecko) ? g.I.Processor.Gecko : {}), ((t.webkit) ? g.I.Processor.Webkit : {}), ((t.presto) ? g.I.Processor.Presto : {})]});
    ...
    g.register("filter > mode change", function (E, F, e, y, A) {
        ...
        function D(K) {
            ...
            var J = y.getCurrentPanel().getWindow().location, I = J.protocol + "//" + J.host, H = J.href,
    ...
    j.addMsg({"@attacher.only.wysiwyg.alert": "\uc5d0\ub514\ud130 \uc0c1\ud0dc\uc5d0\uc11c\ub9cc \ubcf8\ubb38\uc5d0 \uc0bd\uc785\ud560 \uc218 \uc788\uc2b5\ub2c8\ub2e4.\n\uc5d0\ub514\ud130\ubaa8\ub4dc\uc5d0\uc11c \ucca8\ubd80\ubc15\uc2a4\uc758 \uc378\ub124\uc77c\uc744 \ud074\ub9ad\ud574\uc11c \uc0bd\uc785\ud560 \uc218 \uc788\uc2b5\ub2c8\ub2e4."});
    g.Attachment = g.Class.draft({
        $extend: g.Entry, isChecked: c, focused: c, attrs: {align: "left"}, initialize: function (e, w) {
            this.actor = e;
    ...
    p.addSidebar("attachbox", {show: c, destroy: c});
    g.AttachBox = g.Class.create({
        $extend: g.EntryBox, isChecked: c, initialize: function () {
    ...
    g.module("push history @when entrybox has changes", function (x, y, z, w) {
        ...
        e.observeJob(g.Ev.__ENTRYBOX_ENTRY_REMOVED, function (B) {
            w.history.saveHistory({deleted: c}, {deleted: u}, function (C) {
        ...
        e.observeJob(g.Ev.__ENTRYBOX_ENTRY_ADDED, function (B) {
            A(function () {
                w.history.injectHistory({deleted: u}, {deleted: c}, function (C) {
                    B.deletedMark = C.deleted;
                    e.fireJobs(g.Ev.__ENTRYBOX_ENTRY_REFRESH, B)
                })
            })
    ...
    g.I.AttachBox = {
        useBox: u, isDisplay: c, lastSelectedEntry: i, onAttachBoxInitialized: function (A, z) {
            var E = this;
            this.canvas = z;
            var B = ((A.initializedId) ? A.initializedId : "");
            ...
            var C = t("tx_attach_up_size" + B), D = t("tx_attach_max_size" + B), y = t("tx_attach_group_used_size" + B),
            ...
            var A = tx.li({className: "type-" + y.type});
            if (y.actor.boxonly) {
            ...
            var z = tx.dl();
            A.appendChild(z);
            var w = tx.dt({className: "tx-name", unselectable: "on"}, y.boxAttr.name);
            y.elName = w;
            z.appendChild(w);
            t.observe(A, "click", function (C) {
                var D = t.element(C);
            ...
            var x = tx.dd({className: "tx-button"});
            z.appendChild(x);
            var e = tx.a({className: "tx-delete"}, TXMSG("@attacher.del"));
            x.appendChild(e);
            ...
            var B = tx.a({className: "tx-insert"}, TXMSG("@attacher.ins"));
            y.elInsert = B;
            x.appendChild(B);
            ...
            t.setStyle(this.elList, {opacity: 0.3});
            ...
            t.setStyle(this.elList, {opacity: 1})
    ...
    g.Attacher = g.Class.draft({
        $extend: g.Actor, canModified: c, canResized: c, initialize: function (w, y, e) {
            this.editor = w;
            this.canvas = w.getCanvas();
            this.entryBox = y;
            var x = this.config = p.getAttacher(this.constructor.__Identity, e);
            if (e.pvpage && !!x.usepvpage) {
                this.pvUrl = p.getUrl(e.pvpage, {pvname: this.name})
            }
            ...
            if (!this.checkInsertable()) {
                if (this.canModified) {
                    ...
                    alert(x.evaluate({title: this.title}))
                } else {
                    var x = new Template(TXMSG("@attacher.can.modify.confirm"));
                    if (!confirm(x.evaluate({title: this.title}))) {
                        return
                    }
                }
            }
    ...
    j.addMsg({"@embeder.alert": "\uc5d0\ub514\ud130 \uc0c1\ud0dc\uc5d0\uc11c\ub9cc \uc0bd\uc785\ud560 \uc218 \uc788\uc2b5\ub2c8\ub2e4."});
    g.EmbedBox = g.Class.create({
        $extend: g.EntryBox, initialize: function () {
        }
    });
    ...
    g.Embeder = g.Class.draft({
        $extend: g.Actor, canResized: c, initialize: function (w, y, e) {
            this.editor = w;
            this.canvas = w.getCanvas();
    ...
    g.EmbedEntry = g.Class.create({
        $extend: g.Entry, attrs: {align: "left"}, initialize: function (e, w) {
            this.actor = e;
            this.canvas = e.canvas;
            this.entryBox = e.entryBox;
            this.setProperties(w)
            ...
            if (this.canvas.isWYSIWYG()) {
                ...
                if (e) {
                    this.canvas.pasteContent(this.dispHtml, u, {style: e})
                } else {
    ...
    g.I.ButtonFontTool = g.Mixin.create({
        oninitialized: function (w) {
            ...
            return i
        }, cachedProperty: c, syncButton: function (e) {
    ...
    g.I.MenuFontTool = g.Mixin.create({
        oninitialized: function (x) {
            ...
            return e
        }, cachedProperty: c, syncButton: function (w) {
            var e = this;
            e.button.setText(w);
    ...
    g.I.FontTool = g.Mixin.create({
        initialize: function (w, x, e) {
            ...
            var w = this, e, x = w.computeNewStyle(y);
    ...
    g.I.WrappingSpanFontTool = g.Mixin.create({
        wrapTextAsStyledSpan: function (z, B, D) {
            ...
            function y(I) {
                var H = I.getCaret(u), G = I.getCaret(c);
    ...
    g.Tool.Switcher = g.Class.create({
        $const: {__Identity: "switcher"}, $extend: g.Tool, oninitialized: function (w) {
            var C = this.canvas;
            var x = {};
            w.options.each(function (E) {
                x[E.data] = {title: E.title}
            });
            var e = "";
            var A = w.options[0];
            var B = function (E) {
    ...
    p.addTool("switchertoggle", {
        ...
        sync: u,
        status: u,
        options: [{label: "\uc5d0\ub514\ud130", title: "\uc5d0\ub514\ud130", data: "html"}, {
            label: "HTML",
            title: "HTML",
            data: "source"
        }]
    ...
    g.Tool.SwitcherToggle = g.Class.create({
        $const: {__Identity: "switchertoggle"},
        $extend: g.Tool,
        oninitialized: function () {
            var x = this.canvas;
            var w = function () {
            ...
            this.weave.bind(this)(new g.Button.Toggle(p.merge(this.buttonCfg, {borderClass: "tx-switchtoggle"})), i, w);
            var e = function (z, y) {
    ...
    g.Tool.FontFamily = g.Class.create({
        ...
        createMenu: function () {
            var e = this;
            var w = new g.Menu.Select(p.merge(e.menuCfg, {options: e.usedFonts}));
            this.menu = w;
            ...
            if (e.usedWebFonts.length > 0) {
                ...
                var x = tx.input({type: "text", className: "tx-dummyfocus"});
                v.append(w.elMenu, x);
    ...
    g.Tool.FontSize = g.Class.create({
        ...
        createFontSizeMap: function (e) {
            ...
            [{title: "8pt", data: "1"}, {title: "10pt", data: "2"}, {title: "12pt", data: "3"}, {
                title: "14pt",
                data: "4"
            }, {title: "18pt", data: "5"}, {title: "24pt", data: "6"}, {title: "36pt", data: "7"}, {
                title: "7.5pt",
                data: "10px"
            }, {title: "8pt", data: "11px"}, {title: "9pt", data: "12px"}, {
                title: "10pt",
                data: "13px"
            }, {title: "11pt", data: "15px"}, {title: "12pt", data: "16px"}, {
                title: "14pt",
                data: "19px"
            }, {title: "18pt", data: "24px"}, {title: "24pt", data: "32px"}, {
                title: "36pt",
                data: "48px"
            }, {title: "8pt", data: "x-small"}, {title: "10pt", data: "small"}, {
                title: "12pt",
                data: "medium"
            }, {title: "14pt", data: "large"}, {title: "18pt", data: "x-large"}, {
                title: "24pt",
                data: "xx-large"
            }, {title: "36pt", data: "-webkit-xxx-large"}].each(function (x) {
                w[x.data] = x.title
            })
        },
        reliableQueriedValue: function (e) {
    ...
    p.addTool("bold", {wysiwygonly: u, sync: u, status: u, hotKey: {ctrlKey: u, keyCode: 66}});
    g.Tool.Bold = g.Class.create({
        $const: {__Identity: "bold"},
        $extend: g.Tool,
    ...
    p.addTool("underline", {wysiwygonly: u, sync: u, status: u, hotKey: {ctrlKey: u, keyCode: 85}});
    g.Tool.Underline = g.Class.create({
        $const: {__Identity: "underline"},
        $extend: g.Tool,
        $mixins: [g.I.FontTool, g.I.ButtonFontTool, g.I.WrappingDummyFontTool],
        getRelatedCssPropertyNames: function () {
    ...
    p.addTool("italic", {wysiwygonly: u, sync: u, status: u, hotKey: {ctrlKey: u, keyCode: 73}});
    g.Tool.Italic = g.Class.create({
        $const: {__Identity: "italic"},
        $extend: g.Tool,
        $mixins: [g.I.FontTool, g.I.ButtonFontTool, g.I.WrappingDummyFontTool],
        getRelatedCssPropertyNames: function () {
            return ["font", this.getCssPropertyName()]
    ...
    p.addTool("strike", {wysiwygonly: u, sync: u, status: u, hotKey: {ctrlKey: u, keyCode: 68}});
    g.Tool.Strike = g.Class.create({
        $const: {__Identity: "strike"},
        $extend: g.Tool,
        $mixins: [g.I.FontTool, g.I.ButtonFontTool, g.I.WrappingDummyFontTool],
        getRelatedCssPropertyNames: function () {
            return [this.getCssPropertyName()]
    ...
    g.Tool.ForeColor = g.Class.create({
        ...
        syncButton: function (w) {
            try {
                if (w) {
                    t.setStyle(this.button.elButton, {backgroundColor: w})
                }
            } catch (x) {
            }
        }
    ...
    p.addTool("backcolor", {
        ...
        useFavorite: u,
        texts: {
            options: [{color: "#ff0000", text: "#ffffff", label: "\uac00\ub098\ub2e4"}, {
                color: "#e545d0",
                text: "#ffffff",
                label: "\uac00\ub098\ub2e4"
            ...
            findBlocksToIndentFromRange: function (z, C, E) {
                ...
                y.each(function (z) {
                    if (v.kindOf(z, "ul,ol,dl")) {
                        ...
                        if (v.kindOf(z.parentNode, "table") && v.isText(z)) {
                        } else {
                            if (v.kindOf(z.parentNode, "thead,tbody,tfooter") && !v.kindOf(z, "tr")) {
                            } else {
                                if (v.kindOf(z.parentNode, "tr") && !v.kindOf(z, "th,td")) {
                                } else {
                                    if (v.kindOf(z.parentNode, "ul,ol,dl") && !v.kindOf(z, "li,dd,dt")) {
                                    } else {
                                        x.push(z)
                                    }
                                }
            ...
            GoToBelowTable: function (z, x) {
                ...
                if (x) {
                    ...
                    if (v.kindOf(y, "ul,ol,dl")) {
                        ...
                        var B = v.clone(x);
                        v.applyStyles(B, {marginLeft: i, paddingLeft: i});
                        v.wrap(B, z)
                    }
                ...
                v.applyStyles(x, {marginLeft: "+2em"})
    ...
    p.addTool("outdent", {sync: c, status: c, hotKey: {shiftKey: u, keyCode: 9}});
    g.Tool.Outdent = g.Class.create({
        $const: {__Identity: "outdent"}, $extend: g.Tool, oninitialized: function (e) {
            this.weave(new g.Button(this.buttonCfg), i, this.handler);
            this.createHandlers();
            if (t.opera == c) {
            ...
            var w = this.canvas;
            var e = this;
            w.observeKey({keyCode: g.__KEY.BACKSPACE}, function () {
                w.query(function (x) {
    ...
    g.I.AlignExecution = g.Mixin.create({
        executeAlignImageMode: function (x) {
            ...
            if (x && v.kindOf(x, "button")) {
                ...
                z.apply(y, {align: e.style["textAlign"]})
            }
    ...
    (function () {
        p.addTool("alignleft", {sync: u, status: u, hotKey: {ctrlKey: u, keyCode: 188}});
        var x = "left";
        var e = "none";
        var y = "none";
        var w = {align: i, style: {textAlign: x}};
        g.Tool.AlignLeft = g.Class.create({
            $const: {
                __Identity: "alignleft",
                __ImageModeProps: {
                    paragraph: w,
                    image: {style: {clear: y, "float": e, marginLeft: "", marginRight: ""}}
                },
                __TextModeProps: {paragraph: w, button: {style: {margin: "0"}}}
            }, $extend: g.Tool, $mixins: [g.I.AlignExecution], oninitialized: function (A) {
                var z = this;
                z.imageAlignMode = c;
    ...
    (function () {
        p.addTool("aligncenter", {sync: u, status: u, hotKey: {ctrlKey: u, keyCode: 190}});
        var x = "center";
        var e = "none";
        var y = "none";
        var w = {align: i, style: {textAlign: x}};
        g.Tool.AlignCenter = g.Class.create({
            $const: {
                ...
                __TextModeProps: {paragraph: w, button: {style: {margin: "0 auto"}}}
            }, $extend: g.Tool, $mixins: [g.I.AlignExecution], oninitialized: function (A) {
                var z = this;
                z.imageAlignMode = c;
                z.weave(new g.Button(z.buttonCfg), i, z.handler);
    ...
    (function () {
        p.addTool("alignright", {sync: u, status: u, hotKey: {ctrlKey: u, keyCode: 191}});
        var x = "right";
        var e = "left";
        var y = "both";
        var z = "8px";
        ...
        g.Tool.AlignRight = g.Class.create({
            $const: {
                ...
                __ImageModeProps: {image: {style: {clear: y, "float": e, marginLeft: w, marginRight: z}}},
                __TextModeProps: {paragraph: {align: i, style: {textAlign: x}}, button: {style: {margin: "0 0 0 auto"}}}
            }, $extend: g.Tool, $mixins: [g.I.AlignExecution], oninitialized: function (B) {
                var A = this;
                A.imageAlignMode = c;
    ...
    (function () {
        p.addTool("alignfull", {sync: u, status: u});
        var x = "justify";
        var e = "right";
        var y = "both";
        var z = "8px";
        ...
        g.Tool.AlignFull = g.Class.create({
            $const: {
                ...
                __ImageModeProps: {image: {style: {clear: y, "float": e, marginLeft: z, marginRight: w}}},
                __TextModeProps: {paragraph: {align: i, style: {textAlign: x}}, button: {style: {margin: "0"}}}
            }, $extend: g.Tool, $mixins: [g.I.AlignExecution], oninitialized: function () {
                var A = this;
                A.imageAlignMode = c;
                A.weave(new g.Button(A.buttonCfg), i, A.handler);
                A.startSyncButtonWithStyle()
    ...
    g.Tool.Insertcells = g.Class.create({
        $const: {__Identity: "insertcells"}, $extend: g.Tool, oninitialized: function (e) {
            var y = this.canvas;
            ...
            this.weave.bind(this)(new g.Button.Select(p.merge(this.buttonCfg, {selectedValue: A})), new g.Menu.Select(this.menuCfg), x)
        }
    });
    ...
    g.Tool.deletecells = g.Class.create({
        $const: {__Identity: "deletecells"}, $extend: g.Tool, oninitialized: function (e) {
            var x = this.canvas;
            ...
            this.weave.bind(this)(new g.Button.Select(p.merge(this.buttonCfg, {selectedValue: y})), new g.Menu.Select(this.menuCfg), w)
        }
    });
    ...
    g.Tool.Mergecells = g.Class.create({
        ...
        oninitialized: function () {
            ...
            this.weave.bind(this)(new g.Button.Select(p.merge(this.buttonCfg, {selectedValue: x})), new g.Menu.Select(this.menuCfg), e)
        }
    });
    j.addMsg({
    ...
    g.Tool.Cellslineheight = g.Class.create({
        $const: {__Identity: "cellslineheight"},
        $extend: g.Tool,
        oninitialized: function (w) {
            var e = this;
        ...
        createListStyleMap: function (e) {
            ...
            e.options.each(function (x) {
                w[x.data] = {type: x.type, klass: x.klass}
            })
        },
        handler: function (w) {
            var e = this;
    ...
    g.Button.CellslineheightList = g.Class.create({$extend: g.Button.Select});
    ...
    g.Tool.Cellslinecolor = g.Class.create({
        $const: {__Identity: "cellslinecolor"}, $extend: g.Tool, oninitialized: function () {
            var w = this.canvas;
            var e = this;
            ...
            var y = function (z) {
                if (z) {
                    try {
                        t.setStyle(e.button.elButton, {backgroundColor: z})
                    } catch (A) {
                    }
                }
            };
    ...
    g.Button.CellsLineStyledList = g.Class.create({$extend: g.Button.Select});
    ...
    g.Tool.Cellsoutline = g.Class.create({
        $const: {__Identity: "cellsoutline"}, $extend: g.Tool, oninitialized: function (w) {
            var e = this;
            this.twinkleCount = 0;
            this.twinkleTimer = i;
            e.createListStyleMap(w);
    ...
    g.Button.CellsoutlineList = g.Class.create({$extend: g.Button.Select});
    ...
    p.addTool("cellslinepreview", {
        ...
        options: [{
            label: g.MarkupTemplate.get("cellsline.preview").evaluate({
                ...
                width: 70,
                height: 14
            }), title: "1pt solid #ccc", data: "#ccc 1 solid"
        }, {
            label: g.MarkupTemplate.get("cellsline.preview").evaluate({value: "2pt solid #c54", width: 70, height: 14}),
            title: "2pt solid #c54",
            data: "#c54 2 solid"
        }, {
            label: g.MarkupTemplate.get("cellsline.preview").evaluate({value: "2pt solid #67f", width: 70, height: 14}),
            title: "2pt solid #67f",
            data: "#67f 2 solid"
        }, {
            label: g.MarkupTemplate.get("cellsline.preview").evaluate({value: "3pt solid #000", width: 70, height: 14}),
            title: "3pt solid #000",
            data: "#000 3 solid"
        }, {
            label: g.MarkupTemplate.get("cellsline.preview").evaluate({
                ...
                width: 70,
                height: 14
            }), title: "1pt dashed #d4c", data: "#d4c 1 dashed"
        }]
    });
    g.Tool.Cellslinepreview = g.Class.create({
        $const: {__Identity: "cellslinepreview"},
        $extend: g.Tool,
        oninitialized: function (w) {
            var e = this;
            this.data = {color: "", height: 0, type: ""};
    ...
    g.Tool.Tablebackcolor = g.Class.create({
        $const: {__Identity: "tablebackcolor"},
        $extend: g.Tool,
        oninitialized: function () {
            var x = this.canvas;
            var e = this;
    ...
    p.addTool("tableedittool", {sync: c, status: u, opened: c});
    g.Tool.TableEditTool = g.Class.create({
        $const: {__Identity: "tableedittool"}, $extend: g.Tool, oninitialized: function (w) {
            var e = this.toolbar;
            var A = e.el;
    ...
    p.addTool("tabletemplate", {
        ...
        rows: 5,
        cols: 9,
        options: [{label: "image", data: 1, klass: "tx-tabletemplate-1"}, {
            label: "image",
            data: 2,
    ...
    g.Tool.Tabletemplate = g.Class.create({
        $const: {__Identity: "tabletemplate"},
        $extend: g.Tool,
        oninitialized: function (w) {
            var e = this;
            var y = this.canvas;
    ...
    p.addTool("lineheight", {
        sync: c,
        status: u,
        options: [{label: "50%", title: "50%", data: "0.5"}, {label: "80%", title: "80%", data: "0.8"}, {
            label: "100%",
            title: "100%",
            data: "1.0"
        }, {label: "120%", title: "120%", data: "1.2"}, {label: "150%", title: "150%", data: "1.5"}, {
            label: "180%",
            title: "180%",
            data: "1.8"
    ...
    g.Tool.LineHeight = g.Class.create({
        $const: {__Identity: "lineheight"}, $extend: g.Tool, oninitialized: function (e) {
            var y = this.canvas;
    ...
    p.addTool("styledlist", {
        ...
        hotKey: {ul: {ctrlKey: u, altKey: u, keyCode: 85}, ol: {ctrlKey: u, altKey: u, keyCode: 79}}
    });
    g.Tool.StyledList = g.Class.create({
        $const: {__Identity: "styledlist"}, $extend: g.Tool, oninitialized: function (w) {
            var e = this;
            e.createListStyleMap(w);
    ...
    g.Tool.StyledList.ListBuilder = g.Class.create({
        ...
        getNodeDepthList: function (w) {
            ...
            return w.map(function (x) {
                return {node: x, depth: e.countDepthOfList(x)}
            })
        },
    ...
    p.addTool("link", {wysiwygonly: u, sync: c, status: u});
    j.addMsg({
    ...
    g.Tool.Link = g.Class.create({
        $const: {__Identity: "link"}, $extend: g.Tool, oninitialized: function () {
            var e = this;
            var A = this.canvas;
            var y = function (B) {
                if (A.isWYSIWYG()) {
                    if (B) {
                        A.execute(function (C) {
                            var F = {href: B.link, target: B.target ? B.target : "_blank", className: B.className};
                            var E, D;
                            if (C.findNode("a")) {
                                E = C.findNode("a");
                    ...
                    return A.query(function (B) {
                        ...
                        if (C) {
                            ...
                            if (D) {
                                ...
                                return {exist: u, value: D, target: E}
                            }
                        } else {
                            F = B.getText();
                            if (/^\w+\:\/\/\S+/.test(F)) {
                                return {exist: c, value: F}
                            }
                        }
                        return {exist: c, value: x}
                    })
                } else {
                    return {exist: c, value: x}
                }
            ...
            this.bindKeyboard({ctrlKey: u, keyCode: 75}, z)
        }
    });
    ...
    g.Menu.Link = g.Class.create({
        $extend: g.Menu, ongenerated: function () {
            var B = this.elMenu;
            ...
            t.observe(A, "keydown", function (E) {
                if (E.keyCode == 13) {
                    ...
                    this.onSelect(E, {link: F, target: D, className: TXMSG("@insertlink.class.name")});
                    t.stop(E)
                }
    ...
    p.addTool("richtextbox", {
        ...
        bgcolor: "#ffffff",
        padding: "10px",
        styles: [{klass: "", image: "#iconpath/textbox/thum_line01.gif?v=2", data: "solid"}, {
            klass: "",
    ...
    g.Tool.RichTextBox = g.Class.create({
        $const: {__Identity: "richtextbox"}, $extend: g.Tool, oninitialized: function () {
            var y = this.canvas;
            var w = this.toolbar;
            var e = this;
            var x = this.handler = function () {
                ...
                var A = "div";
                var B = {className: "txc-textbox", style: z};
    ...
    g.Menu.RichTextbox = g.Class.create({
        $extend: g.Menu, ongenerated: function (P) {
            var D = this;
            var z = {};
            ...
            (function I() {
                var U = D.simplePalette = tx.div({className: "tx-menu-list"});
                w.appendChild(U);
                var S = P.rows;
                var T = P.cols;
            ...
            (function y() {
                var S = D.advancedPalette = tx.div({className: "tx-advanced-list"});
                w.appendChild(S);
                S.appendChild(tx.dl({style: {height: "24px"}}, tx.dt(TXMSG("@richtextbox.border.style")), O()));
            ...
            var Q = function (S) {
                ...
                D.fireJobs(g.Ev.__MENU_LAYER_CHANGE_SIZE, {detail: {menu: D}})
            };
            (function F() {
            ...
            var w = this;
            var e = tx.dd({className: "tx-border-area"});
            ...
            var A = this;
            var w = tx.dd({className: "tx-border-area"});
            var z = this.borderWidthInput = tx.input({type: "text", value: this.borderWidth});
            w.appendChild(z);
            var x = function (B) {
                if (B > 20) {
            ...
            var y = tx.a({href: "javascript:;", className: "btn_add"}, TXMSG("@richtextbox.add"));
            w.appendChild(y);
            t.observe(y, "click", function (B) {
                x(z.value.toNumber() + 1);
                t.stop(B)
            });
            var e = tx.a({href: "javascript:;", className: "btn_sub"}, TXMSG("@richtextbox.sub"));
            w.appendChild(e);
            ...
            var e = this;
            var x = new g.Menu.ColorPallete({el: w, thumbs: this.config.thumbs});
            x.setCommand(y);
            ...
            var C = this;
            var x = g.MarkupTemplate.get("richtextbox.colorpallete").evaluateAsDom({color: this.bgColor});
    ...
    p.addTool("quote", {
        ...
        rows: 2,
        cols: 3,
        options: [{type: "image", data: "tx-quote1", image: "#iconpath/quote/citation01.gif?v=2"}, {
            type: "image",
            data: "tx-quote2",
    ...
    g.Tool.Quote = g.Class.create({
        $const: {__Identity: "quote"}, $extend: g.Tool, oninitialized: function (w) {
            var e = this;
            var z = this.canvas;
            var A = {};
            w.options.each(function (B) {
                A[B.data] = {type: B.type}
            });
            var x = function (D) {
                if (!A[D]) {
                    return
            ...
            this.bindKeyboard({ctrlKey: u, keyCode: 81}, y)
        }
    });
    p.addTool("table", {borderStyle: "1px solid #ccc", sync: c, status: u}, function (w) {
        var e = p.get("canvas", w).styles.backgroundColor;
        if (e != "transparent") {
            p.getTool("table", w).bgcolor = e
        }
    });
    j.addMsg({"@table.alert": "1 \uc774\uc0c1 99 \uc774\ud558\uc758 \uc22b\uc790\ub9cc \uc785\ub825 \uac00\ub2a5\ud569\ub2c8\ub2e4."});
    g.Tool.Table = g.Class.create({
        $const: {
        ...
        }, $extend: g.Tool, oninitialized: function (w) {
            var e = this;
            ...
            var B = parseInt(C / e).toPx(), A = g.Tool.Table.__DEFAULT_TABLE_CELL_HEIGHT.toPx();
    ...
    g.Tool.Table.TemplateWizard = g.Class.create({
        initialize: function () {
            this.templateList = (typeof getTableTemplateList == "function") ? getTableTemplateList() : [{
                ...
                firstRow: {borderTop: "1px solid #000"},
                firstCol: {borderLeft: "1px solid #000"},
                lastCol: {borderRight: "1px solid #000"},
                lastRow: {borderBottom: "1px solid #000"},
                evenRow: {},
                oddRow: {}
            }];
    ...
    g.Menu.Table = g.Class.create({
        $const: {MAX_ROW: 99, MAX_COL: 99}, $extend: g.Menu, ongenerated: function () {
            this.rowSize = 1;
            this.colSize = 1;
            ...
            var w = this;
            var B = tx.span();
            var z = tx.div({className: "tx-dynamic-sizer-display"}, TXMSG("@table.title.insert"), B);
            y.appendChild(z);
            var A = new g.DynamicSizer({
                el: y, clickHandler: this.onSelect.bind(this), moveHandler: function (D, C) {
                    B.innerHTML = D + "x" + C
                }
            });
            var e = tx.a({href: "javascript:;"}, TXMSG("@table.title.setDirectly"));
            t.observe(e, "click", function (C) {
                w.showTextSizer();
                t.stop(C);
                w.fireJobs(g.Ev.__MENU_LAYER_CHANGE_SIZE, {detail: {menu: w}})
            });
            var x = tx.div({className: "tx-more-button"});
            x.appendChild(e);
            y.appendChild(x);
            return A
            ...
            var e = this;
            var y = tx.div();
            var z = tx.a({href: "javascript:;", className: "tx-btn-confirm"}, "\ud655\uc778");
            var w = tx.a({href: "javascript:;", className: "tx-btn-cancel"}, "\ucde8\uc18c");
            t.observe(z, "click", function (A) {
                e.onSelect(A, {row: e.rowSize, col: e.colSize})
            });
            t.observe(w, "click", function () {
                this.onCancel();
                return c
    ...
    (function () {
        ...
        p.addTool("emoticon", {
            ...
            matrices: [{
                ...
                options: e("things", 35),
                defaultshow: u
            }, {title: TXMSG("@emoticon.subtitle.etc"), klass: "tx-menu-matrix-etc", options: e("etc", 29)}],
    ...
    p.addTool("redo", {sync: c, status: c});
    g.Tool.ReDo = g.Class.create({
        $const: {__Identity: "redo"}, $extend: g.Tool, oninitialized: function () {
            var w = this.canvas;
            var e = function () {
                w.getProcessor().blur();
                w.focus();
            ...
            this.bindKeyboard({ctrlKey: u, keyCode: 89}, function () {
                w.fireJobs("canvas.panel.redo");
                w.triggerQueryStatus()
            })
        }
    });
    p.addTool("undo", {sync: c, status: c});
    g.Tool.UnDo = g.Class.create({
        $const: {__Identity: "undo"}, $extend: g.Tool, oninitialized: function () {
            var w = this.canvas;
            var e = function () {
                w.getProcessor().blur();
                w.focus();
    ...
    p.addTool("removeformat", {wysiwygonly: u, sync: u, status: c, hotKey: {ctrlKey: u, shiftKey: u, keyCode: 88}});
    ...
    g.Tool.HorizontalRule = g.Class.create({
        $const: {__Identity: "horizontalrule"},
        $extend: g.Tool,
        oninitialized: function (e) {
            var x = this.canvas;
            var y = {};
            e.options.each(function (z) {
                y[z.data] = {html: z.html}
            });
            var w = function (A) {
                if (!y[A]) {
                    return
    ...
    (function () {
        ...
        p.addTool("specialchar", {
            sync: c, status: u, rows: 9, cols: 20, top: i, left: i, matrices: [{
    ...
    p.addTool("dictionary", {url: "http://engdic.daum.net/dicen/small_view_top.do", sync: c, status: c});
    g.Tool.Dictionary = g.Class.create({
        $const: {__Identity: "dictionary"},
        $extend: g.Tool,
        oninitialized: function (e) {
            var x = this.canvas;
            var w = function () {
    ...
    (function () {
        ...
        g.Tool.Background = g.Class.create({
            $const: {__Identity: "background"}, $extend: g.Tool, oninitialized: function () {
                ...
                }, {backgroundColor: x, backgroundImage: y.getStyle("backgroundImage")}, function (z) {
                    w._restoreColor(z)
                });
                if (x === null) {
                    y.addStyle({
                    ...
                    y.addStyle({backgroundColor: x, backgroundImage: ""});
                    e = x;
                    y.getConfig().hasUserBgcolor = u
                }
            }, _restoreColor: function (x) {
                var w = this.canvas;
                w.addStyle({backgroundColor: x.backgroundColor});
                if (x.backgroundImage) {
                    w.addStyle({backgroundImage: x.backgroundImage})
                }
                e = x.backgroundColor
            }
        });
        g.install("canvas.getBgColor & canvas.setBgColor & editor.getContentWithBg", function (z, A, B, y, x) {
            ...
            y.setBgColor = function (C) {
                y.getPanel("html").addStyle({backgroundColor: C || "transparent"})
            };
            ...
            y.reserveJob(g.Ev.__IFRAME_LOAD_COMPLETE, function () {
                ...
                if (C && C != "transparent") {
                    y.addStyle({backgroundColor: C, backgroundImage: ""})
                }
            });
            y.observeJob("canvas.apply.letterpaper", function (C) {
                if (C.id) {
                    y.getPanel("html").addStyle({backgroundColor: "transparent"})
                }
            })
        })
    })();
    p.addTool("advanced", {sync: c, status: u, opened: c});
    g.Tool.Advanced = g.Class.create({
        $const: {__Identity: "advanced"}, $extend: g.Tool, oninitialized: function (x) {
            var e = this;
            var w = this.toolbar;
            var A = w.el;
            e.opened = c;
    ...
    g.module("add drop-down menu button if extra buttons exist.", function (w, x, y, e) {
        e.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function () {
            ...
            z.each(function (B) {
                ...
                x.makeWidget(new g.Button({el: B, sync: c, status: u}), new g.Menu({el: A}), function () {
                })
            })
        })
    });
    (function () {
        ...
        g.Tool.FullScreen = g.Class.create({
            $const: {__Identity: "fullscreen"},
            $extend: g.AsyncTool,
            oninitialized: function (w) {
                this.weave.bind(this)(new g.Button(this.buttonCfg), i, this.onLoadModule);
                var e = this;
                this.bindKeyboard({ctrlKey: u, keyCode: 77}, function () {
                    if (!e.loaded) {
                        e.onLoadModule()
                    }
                })
    ...
    p.addTool("image", {disabledonmobile: u, wysiwygonly: u, sync: c, status: c});
    j.addMsg({"@image.title": "\uc0ac\uc9c4"});
    g.Tool.Image = g.Class.create({
        $const: {__Identity: "image"}, $extend: g.Tool, oninitialized: function () {
            var e = this.editor;
    ...
    g.Attacher.Image = g.Class.create({
        ...
        getDataForEntry: function (x) {
            ...
            var w = Object.extend({dataSeq: e}, x);
            return w
        },
        createEntry: function (w, e) {
            return this.createAttachment(w, e)
    ...
    g.Attachment.Image = g.Class.create({
        $const: {__Identity: "image"}, $extend: g.Attachment, getFieldAttr: function (e) {
            return {
            ...
            return {name: w.filename + " (" + e + w.filesize.toByteUnit() + ")", image: w.thumburl}
    ...
    p.addTool("file", {disabledonmobile: u, wysiwygonly: u, sync: c, status: c});
    j.addMsg({"@file.title": "\ud30c\uc77c"});
    g.Tool.File = g.Class.create({
        $const: {__Identity: "file"}, $extend: g.Tool, oninitialized: function () {
            var e = this.editor;
            this.weave.bind(this)(new g.Button(this.buttonCfg), i, function () {
    ...
    g.Attachment.File = g.Class.create({
        $const: {__Identity: "file"}, $extend: g.Attachment, getFieldAttr: function (e) {
            return {name: "tx_attach_file", value: [e.attachurl, e.filesize, e.filename].join("|")}
            ...
            return {name: x + " (" + z.filesize.toByteUnit() + ")", image: z.thumburl}
        }, getObjectStyle: function (x) {
            var w = {};
            if (this.actor.config.objstyle) {
                w = Object.extend(w, this.actor.config.objstyle)
    ...
    p.addTool("media", {wysiwygonly: u, sync: c, status: c});
    j.addMsg({
        "@media.title": "\uba40\ud2f0\ubbf8\ub514\uc5b4",
    ...
    g.Tool.Media = g.Class.create({
        $const: {__Identity: "media"}, $extend: g.Tool, oninitialized: function () {
            var e = this.editor;
            this.weave.bind(this)(new g.Button(this.buttonCfg), i, function () {
    ...
    p.addEmbeder("media", {
        wysiwygonly: u,
        useCC: c,
        features: {left: 250, top: 65, width: 458, height: 568, resizable: "yes"},
    ...
    g.module("Register an eventhandler in order to change align icons upon toolbar when user click a specific image or not.", function (y, A, B, x) {
        ...
        x.observeElement([{tag: "body"}, {tag: "table"}, {tag: "hr"}], function () {
            z("text")
        });
        x.observeElement({tag: "img"}, function (E) {
    ...
    g.module("make padding area inside Canvas with editor width", function (A, K, M, y) {
        ...
        if (z) {
            ...
            if (!t.msie_nonstd) {
                if (t.gecko) {
                    t.setStyle(O, {overflowX: "auto", overflowY: "auto"})
                } else {
                    t.setStyle(O, {overflowX: "auto", overflowY: "scroll"})
                }
            }
        }
        ...
        function I() {
            var Y = w();
            if (Y < D) {
                return {leftWidth: "0", rightWidth: "0", rightPos: "0"}
            } else {
                return {
        ...
        function e() {
            ...
            E = tx.div({className: "tx-wysiwyg-padding"});
            B = tx.div({className: "tx-wysiwyg-padding-divL", style: {borderColor: Y}});
            x = tx.div({className: "tx-wysiwyg-padding"});
            R = tx.div({className: "tx-wysiwyg-padding-divR", style: {borderColor: Y}});
            var Z = y.wysiwygEl;
            E.appendChild(B);
            Z.insertBefore(E, O);
            x.appendChild(R);
        ...
        function H() {
            if (W()) {
                var Z = I();
                t.setStyle(E, {width: Z.leftWidth});
                t.setStyle(x, {width: Z.rightWidth, left: Z.rightPos});
                var Y = Z.leftWidth.parsePx() > D;
                var aa = y.getConfig().showGuideArea;
                var ab = Y && aa ? "1px solid" : "0 none";
                t.setStyle(B, {borderRight: ab, borderBottom: ab});
                t.setStyle(R, {borderLeft: ab, borderBottom: ab})
            }
        }
    ...
    g.module("Register an eventhandler in order to resize block and edit search results & some images in wysiwig panel.", function (y, z, A, w) {
        if (t.msie_nonstd) {
            ...
            w.observeElement({tag: "img", klass: "tx-unresizable"}, e);
            w.observeElement({tag: "img", klass: "tx-entry-attach"}, e);
            w.observeElement({tag: "img", klass: "txc-footnote"}, e);
            w.observeElement({tag: "iframe", klass: "txc-map"}, e)
        }
        var x;
        if (t.msie_nonstd) {
            x = function (B) {
        ...
        w.observeElement({tag: "button"}, x);
        w.observeElement({tag: "img"}, function (B) {
    ...
    g.module("Add layer to display notice message on editor area before editing", function (x, y, z, w, e) {
        if (e.initializedMessage) {
            w.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function () {
                var E = tx.div({id: "tx-canvas-notice", className: "tx-canvas-notice"}, e.initializedMessage);
                var B = t("tx_loading");
                var A = B.parentNode;
                A.insertBefore(E, B);
                var D = false;
    ...
    j.addMsg({"@table.noselect.alert": "\ud14c\uc774\ube14\uc744 \uc120\ud0dd\ud558\uc2e0 \ud6c4 \uc0ac\uc6a9\uac00\ub2a5\ud569\ub2c8\ub2e4."});
    g.Table = {};
    g.module("table selector", function (y, z, A, x, w) {
        ...
        x.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function () {
            ...
            x.observeElement({tag: "table"}, function (N) {
                if (z.tools.advanced) {
                    z.tools.advanced.forceOpen()
                }
            });
            var B = {range: "all", color: "", height: 1, type: "solid"};
            var L = function () {
            ...
            F.table = {
                getTdArr: function () {
                    ...
                    B.color = N;
                    z.fireJobs(g.Ev.__TOOL_CELL_LINE_CHANGE, {color: N})
                }, setBorderHeight: function (N) {
                    B.height = N;
                    z.fireJobs(g.Ev.__TOOL_CELL_LINE_CHANGE, {height: N})
                }, setBorderType: function (N) {
                    B.type = N;
                    z.fireJobs(g.Ev.__TOOL_CELL_LINE_CHANGE, {type: N})
                    ...
                    return {color: B.color, height: B.height, type: B.type}
            ...
            z.fireJobs(g.Ev.__TOOL_CELL_LINE_CHANGE, {color: B.color, height: B.height, type: B.type, fromInit: u});
    ...
    g.Table.Selector = g.Class.create({
        ...
        getSizeOfSelected: function () {
            ...
            if (0 < w.length) {
                ...
                e = v.getPosition(x);
                z = v.getPosition(y);
                return {width: z.x + z.width - e.x, height: z.y + z.height - e.y}
            }
    ...
    g.Table.Insert = g.Class.create({
        COL_DIRECTION: {LEFT: "left", RIGHT: "right"}, initialize: function (w) {
            var e;
            e = w.getCanvas();
            this.wysiwygPanel = e.getPanel(g.Canvas.__WYSIWYG_MODE)
            ...
            w = B.bottom - B.top + 1;
            e = B.top;
            z = x.getTdArr(new g.TableUtil.Boundary({top: B.top, right: x.getColSize() - 1, bottom: B.top, left: 0}));
            ...
            var w, x, y;
            w = z.right - z.left + 1;
            x = e.getTdArr(new g.TableUtil.Boundary({top: 0, right: z.left, bottom: e.getRowSize() - 1, left: z.left}));
    ...
    g.Table.Delete = g.Class.create({
        initialize: function (w) {
            ...
            return w.getTdArr(new g.TableUtil.Boundary({top: e, right: w.getColSize() - 1, bottom: e, left: 0}))
            ...
            return w.getTdArr(new g.TableUtil.Boundary({top: 0, right: e, bottom: w.getRowSize() - 1, left: e}))
        }
    });
    g.Table.Border = g.Class.create({
        $const: {BORDER_STYLE: "1px solid #ccc"}, initialize: function (x, w) {
            var e;
            e = x.getCanvas();
            this.wysiwygPanel = e.getPanel(g.Canvas.__WYSIWYG_MODE);
            ...
            if (x.top == 0) {
                E = "borderTop" + D;
                y = new g.TableUtil.Boundary({top: x.top, bottom: x.top, left: x.left, right: x.right})
            } else {
                E = "borderBottom" + D;
                y = new g.TableUtil.Boundary({top: x.top - 1, bottom: x.top - 1, left: x.left, right: x.right})
            }
            e = B.getTdArr(y);
            w[E] = C;
            ...
            var B = this.tableSelect.getIndexer();
            E = "borderBottom" + D;
            z = new g.TableUtil.Boundary({top: x.bottom, bottom: x.bottom, left: x.left, right: x.right});
            e = B.getTdArr(z);
            w[E] = C;
            for (var A = 0; A < e.length; A++) {
                t.setStyle(e[A], w)
            ...
            if (x.left == 0) {
                E = "borderLeft" + D;
                y = new g.TableUtil.Boundary({top: x.top, bottom: x.bottom, left: x.left, right: x.left})
            } else {
                E = "borderRight" + D;
                y = new g.TableUtil.Boundary({top: x.top, bottom: x.bottom, left: x.left - 1, right: x.left - 1})
            }
            e = B.getTdArr(y);
            w[E] = C;
            for (var A = 0; A < e.length; A++) {
            ...
            var y;
            E = "borderRight" + D;
            y = new g.TableUtil.Boundary({top: x.top, bottom: x.bottom, left: x.right, right: x.right});
            e = B.getTdArr(y);
            w[E] = C;
            for (var A = 0; A < e.length; A++) {
                t.setStyle(e[A], w)
            ...
            F = "borderBottom" + H;
            A = new g.TableUtil.Boundary({top: y.top, bottom: y.bottom - 1, left: y.left, right: y.right});
            I = E.getTdArr(A);
            C[F] = G;
            for (var D = 0; D < I.length; D++) {
                t.setStyle(I[D], C)
            ...
            x = "borderRight" + H;
            w = new g.TableUtil.Boundary({top: y.top, bottom: y.bottom, left: y.left, right: y.right - 1});
            e = E.getTdArr(w);
            z[x] = G;
    ...
    g.module("table resize dragger", function (w, x, y, e) {
        e.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function () {
            ...
            var aj, K, ab;
            var W, V, aI;
            var aJ = {TOP: "EDGE_TOP", BOTTOM: "EDGE_BOTTOM", LEFT: "EDGE_LEFT", RIGHT: "EDGE_RIGHT", NONE: "NONE"};
            var ae = aJ.NONE;
            var L = function () {
                Z = c;
                aC = i;
            ...
            var T = function (aU) {
                ...
                if ("getBoundingClientRect" in document.documentElement) {
                    try {
                        var a4 = aU.ownerDocument, aS = a4.documentElement, aY = a4.body;
                        var aX = aU.getBoundingClientRect(), aZ = a4.defaultView || a4.parentWindow,
                            aW = aS.clientTop || aY.clientTop || 0, a1 = aS.clientLeft || aY.clientLeft || 0,
                            aR = aZ.pageYOffset || aB && aS.scrollTop || aY.scrollTop,
                            aV = aZ.pageXOffset || aB && aS.scrollLeft || aY.scrollLeft, a2 = aX.top + aR - aW,
                            aT = aX.left + aV - a1;
                        a3 = {top: a2, left: aT, bottom: a2 + aU.offsetHeight, right: aT + aU.offsetWidth}
                    } catch (a0) {
                        a3 = i
                    }
                }
            ...
            var af = function (aS) {
                ...
                if (Z) {
                    ...
                    t.setStyle(aS, {height: "2px", border: "1px dotted #81aFFC", background: "", top: aR.toPx()});
                    t.setOpacity(aN, 1)
                } else {
                    aR = V - v.getScrollTop(I);
                    t.setStyle(aS, {height: "2px", border: "", background: "#fff", top: aR.toPx()});
                    t.setOpacity(aN, 0)
                }
            };
            var N = function () {
