...
export default function ExcelDownloadButton() {
    ...
    const fetchData = async () => {
        ...
        {
            const apiRes = await callApi(`/api/admin/managed-users/${useProjectTrackerStore.getState().userId}/projects/${selectedProject.id}/buyer/list`, options);
            if (apiRes.result) {
        ...
        {
            const apiRes = await callApi(`/api/admin/managed-users/${useProjectTrackerStore.getState().userId}/projects/${selectedProject.id}/buyer/manager/list`, options);
            if (apiRes.result) {
