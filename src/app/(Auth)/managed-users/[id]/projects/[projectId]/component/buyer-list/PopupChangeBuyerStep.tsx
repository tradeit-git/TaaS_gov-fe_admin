...
export default function PopupChangeBuyerStep (props: {
    ...
    const handleUpdateBuyerStep = async () => {
        ...
        const apiRes = await callApi(`/api/admin/managed-users/${useProjectTrackerStore.getState().userId}/projects/${props.projectId}/buyer/${props.buyer.id}/updateBuyerStep`, options);
        if (apiRes.result) {
