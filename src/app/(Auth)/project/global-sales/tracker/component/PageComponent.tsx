...
import ProjectBuyer from "@/app/(Auth)/project/global-sales/tracker/component/buyer-list/ProjectBuyer";
import ActivityReportBox from "@/app/(Auth)/project/global-sales/tracker/component/sales-log-list/ActivityReportBox";
import ProjectBox from "@/app/(Auth)/project/global-sales/tracker/component/ProjectBox";
...
export const fetchProject = async (projectId: number) => {
    ...
    const projectApiRes = await callApi(`/api/admin/projects/${projectId}`, options);
    ...
    const buyerApiRes = await callApi(`/api/admin/project/${projectId}/buyer/list`, options);
...
export const fetchBuyerDetail = async (projectId: number, buyerId: number) => {
    ...
    const buyerDetailApiRes = await callApi(`/api/admin/project/${projectId}/buyer/${buyerId}/detail`, options);
    ...
    const stepHistoryApiRes = await callApi(`/api/admin/project/${projectId}/buyer/${buyerId}/buyerStepHistories`, options);
...
export const fetchBuyerSalesLogs = async (projectId: number, buyerId: number) => {
    ...
    const apiRes = await callApi(`/api/admin/project/${projectId}/buyer/${buyerId}/salesLogsNoContents`, options);
    if (apiRes.result) {
...
export const fetchBuyerSalesLogDetail = async (projectId: number, buyerId: number, buyerSalesLogId: number) => {
    ...
    const apiRes = await callApi(`/api/admin/project/${projectId}/buyer/${buyerId}/salesLog/${buyerSalesLogId}`, options);
    if (apiRes.result) {
