...
export default function ReportForm(props: {
    ...
    const handleSaveSalesLog = async () => {
        ...
        const apiRes = await callApi(`/api/admin/project/${selectedProject.id}/buyer/${selectedBuyerId}/salesLog/store`, options);
    ...
    const handleDeleteSalesLog = () => {
        const callback = async () => {
            ...
            const apiRes = await callApi(`/api/admin/project/${selectedProject.id}/buyer/${selectedBuyerId}/salesLog/${props.buyerSalesLog.id}/delete`, options);
            if (apiRes.result) {
                fetchProject(selectedProject.id).then( res => {
                    const {project : _project,buyers : _buyers} = res;
                    setSelectedProject(_project);
