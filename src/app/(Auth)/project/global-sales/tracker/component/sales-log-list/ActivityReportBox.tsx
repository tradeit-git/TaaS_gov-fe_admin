...
import ReportListItems from "@/app/(Auth)/project/global-sales/tracker/component/sales-log-list/ReportListItems"
...
import ReportForm from "@/app/(Auth)/project/global-sales/tracker/component/sales-log-detail/ReportForm";
import AlertComponent from "@/app/(Auth)/components/AlertComponent";
import PopupAllView from "@/app/(Auth)/project/global-sales/tracker/component/sales-log-list/PopupAllView";
import {safeCompare, sortByKey} from "@/utill/compare";
import {fetchBuyerSalesLogDetail, fetchBuyerSalesLogs} from "@/app/(Auth)/project/global-sales/tracker/component/PageComponent";
                    ...
                    {buyerSalesLogs.length > 0 && (
                        <button className={'view_all'}
                                onClick={async () => {
                                    ...
                                    const apiRes = await callApi(`/api/admin/project/${selectedProject.id}/buyer/${buyer.id}/salesLogs`, options);
                                    if (apiRes.result) {
