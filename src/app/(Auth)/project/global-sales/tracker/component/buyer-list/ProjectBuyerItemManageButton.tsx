...
import PopupChangeBuyerStep from "@/app/(Auth)//project/global-sales/tracker/component/buyer-list/PopupChangeBuyerStep";
    ...
    const ButtonWrap = useMemo(() => {
        const handleDeleteBuyer = () => {
            const fnc = async () => {
                ...
                const apiRes = await callApi(`/api/admin/project/${selectedProject.id}/buyer/${props.buyer.id}`, options);
                if (apiRes.result) {
        ...
        const handleSetReleaseBuyer = (isRelease: boolean) => {
            ...
            const fnc = async () => {
                ...
                const apiRes = await callApi(`/api/admin/project/${selectedProject.id}/buyer/${props.buyer.id}/setBuyerRelease`, options);
                if (apiRes.result) {
