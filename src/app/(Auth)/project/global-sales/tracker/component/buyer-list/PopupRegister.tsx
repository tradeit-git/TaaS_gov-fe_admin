...
import PopupRegisterNationSearch from "@/app/(Auth)/project/global-sales/tracker/component/buyer-list/PopupRegisterNationSearch";
...
import PopupRegisterBuyerManagerInfo from "@/app/(Auth)/project/global-sales/tracker/component/buyer-list/PopupRegisterBuyerManagerInfo";
...
export default function PopupRegister(props : {
    ...
    const fetchProject = async (projectId: number) => {
        ...
        {  //프로젝트 세팅
            const apiRes = await callApi(`/api/admin/project/${projectId}`, options);
            if (apiRes.result) {
        ...
        {   //프로젝트 바이어 세팅
            const apiRes = await callApi(`/api/admin/project/${projectId}/buyer/list`, options);
            if (apiRes.result) {
    ...
    const handleStoreBuyerInfo = () => {
        ...
        if(valid){
            const saveFunction = async () => {
                ...
                const apiRes = await callApi(`/api/admin/project/${selectedProject.id}/buyer/store`, options);
                if (apiRes.result) {
